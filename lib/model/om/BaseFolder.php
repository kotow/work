...
abstract class BaseFolder extends BaseObject  implements Persistent {
	...
	public function setLabel($v)
	{
		...
		if ($this->label !== $v) {
			$this->label = $v;
			$this->modifiedColumns[] = FolderPeer::LABEL;
		}
	...
	public function setPublicationStatus($v)
	{
		...
		if ($this->publication_status !== $v) {
			...
			$this->modifiedColumns[] = FolderPeer::PUBLICATION_STATUS;
		}
	...
	{
    if ($this->isNew() && !$this->isColumnModified(FolderPeer::CREATED_AT))
    {
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(FolderPeer::LABEL)) $criteria->add(FolderPeer::LABEL, $this->label);
		...
		if ($this->isColumnModified(FolderPeer::PUBLICATION_STATUS)) $criteria->add(FolderPeer::PUBLICATION_STATUS, $this->publication_status);
