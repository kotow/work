...
abstract class BaseKeyword extends BaseObject  implements Persistent {
	...
	public function setLabel($v)
	{
		...
		if ($this->label !== $v) {
			$this->label = $v;
			$this->modifiedColumns[] = KeywordPeer::LABEL;
		}
	...
	public function setCreatedAt($v)
	{
		...
		if ($this->created_at !== $ts) {
			$this->created_at = $ts;
			$this->modifiedColumns[] = KeywordPeer::CREATED_AT;
		}
	...
	public function setUpdatedAt($v)
	{
		...
		if ($this->updated_at !== $ts) {
			$this->updated_at = $ts;
			$this->modifiedColumns[] = KeywordPeer::UPDATED_AT;
		}
	...
	public function setPublicationStatus($v)
	{
		...
		if ($this->publication_status !== $v) {
			...
			$this->modifiedColumns[] = KeywordPeer::PUBLICATION_STATUS;
		}
	...
	{
    if ($this->isNew() && !$this->isColumnModified(KeywordPeer::CREATED_AT))
    {
      $this->setCreatedAt(time());
    }

    if ($this->isModified() && !$this->isColumnModified(KeywordPeer::UPDATED_AT))
    {
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(KeywordPeer::LABEL)) $criteria->add(KeywordPeer::LABEL, $this->label);
		if ($this->isColumnModified(KeywordPeer::CREATED_AT)) $criteria->add(KeywordPeer::CREATED_AT, $this->created_at);
		if ($this->isColumnModified(KeywordPeer::UPDATED_AT)) $criteria->add(KeywordPeer::UPDATED_AT, $this->updated_at);
		if ($this->isColumnModified(KeywordPeer::PUBLICATION_STATUS)) $criteria->add(KeywordPeer::PUBLICATION_STATUS, $this->publication_status);
