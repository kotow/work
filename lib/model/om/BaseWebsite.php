...
abstract class BaseWebsite extends BaseObject  implements Persistent {
	...
	public function setLabel($v)
	{
		...
		if ($this->label !== $v) {
			$this->label = $v;
			$this->modifiedColumns[] = WebsitePeer::LABEL;
		}
	...
	public function setUrl($v)
	{
		...
		if ($this->url !== $v) {
			$this->url = $v;
			$this->modifiedColumns[] = WebsitePeer::URL;
		}
	...
	public function setPublicationStatus($v)
	{
		...
		if ($this->publication_status !== $v) {
			...
			$this->modifiedColumns[] = WebsitePeer::PUBLICATION_STATUS;
		}
	...
	{
    if ($this->isNew() && !$this->isColumnModified(WebsitePeer::CREATED_AT))
    {
	...
	protected function doSave($con)
	{
		$affectedRows = 0; 		if (!$this->alreadyInSave) {
			$this->alreadyInSave = true;
						...
						if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = WebsitePeer::doInsert($this, $con);
					$affectedRows += 1; 										 										 
					$this->setNew(false);
				} else {
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(WebsitePeer::LABEL)) $criteria->add(WebsitePeer::LABEL, $this->label);
		if ($this->isColumnModified(WebsitePeer::URL)) $criteria->add(WebsitePeer::URL, $this->url);
		...
		if ($this->isColumnModified(WebsitePeer::PUBLICATION_STATUS)) $criteria->add(WebsitePeer::PUBLICATION_STATUS, $this->publication_status);
