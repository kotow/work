...
abstract class BaseClientPeer {
	...
	const ID = 'm_client.ID';

	
	const LABEL = 'm_client.LABEL';

	
	const ADDRESS = 'm_client.ADDRESS';

	
	const CREATED_AT = 'm_client.CREATED_AT';

	
	const UPDATED_AT = 'm_client.UPDATED_AT';

	
	const PUBLICATION_STATUS = 'm_client.PUBLICATION_STATUS';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Label', 'Address', 'CreatedAt', 'UpdatedAt', 'PublicationStatus', ),
		BasePeer::TYPE_COLNAME => array (ClientPeer::ID, ClientPeer::LABEL, ClientPeer::ADDRESS, ClientPeer::CREATED_AT, ClientPeer::UPDATED_AT, ClientPeer::PUBLICATION_STATUS, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'label', 'address', 'created_at', 'updated_at', 'publication_status', ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
	);

	
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Label' => 1, 'Address' => 2, 'CreatedAt' => 3, 'UpdatedAt' => 4, 'PublicationStatus' => 5, ),
		BasePeer::TYPE_COLNAME => array (ClientPeer::ID => 0, ClientPeer::LABEL => 1, ClientPeer::ADDRESS => 2, ClientPeer::CREATED_AT => 3, ClientPeer::UPDATED_AT => 4, ClientPeer::PUBLICATION_STATUS => 5, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'label' => 1, 'address' => 2, 'created_at' => 3, 'updated_at' => 4, 'publication_status' => 5, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(ClientPeer::LABEL);
		...
		$criteria->addSelectColumn(ClientPeer::PUBLICATION_STATUS);

	}

	const COUNT = 'COUNT(m_client.ID)';
	const COUNT_DISTINCT = 'COUNT(DISTINCT m_client.ID)';
