...
abstract class BaseMenuPeer {
	...
	const TABLE_NAME = 'm_website_menu';
	...
	const ID = 'm_website_menu.ID';

	
	const LABEL = 'm_website_menu.LABEL';

	
	const PUBLICATION_STATUS = 'm_website_menu.PUBLICATION_STATUS';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Label', 'PublicationStatus', ),
		BasePeer::TYPE_COLNAME => array (MenuPeer::ID, MenuPeer::LABEL, MenuPeer::PUBLICATION_STATUS, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'label', 'publication_status', ),
		BasePeer::TYPE_NUM => array (0, 1, 2, )
	);

	
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Label' => 1, 'PublicationStatus' => 2, ),
		BasePeer::TYPE_COLNAME => array (MenuPeer::ID => 0, MenuPeer::LABEL => 1, MenuPeer::PUBLICATION_STATUS => 2, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'label' => 1, 'publication_status' => 2, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(MenuPeer::LABEL);

		$criteria->addSelectColumn(MenuPeer::PUBLICATION_STATUS);

	}

	const COUNT = 'COUNT(m_website_menu.ID)';
	const COUNT_DISTINCT = 'COUNT(DISTINCT m_website_menu.ID)';
