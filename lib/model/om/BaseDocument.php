...
abstract class BaseDocument extends BaseObject  implements Persistent {
	...
	public function setDocumentModel($v)
	{
		...
		if ($this->document_model !== $v) {
			...
			$this->modifiedColumns[] = DocumentPeer::DOCUMENT_MODEL;
		}

	} 
	
	public function setDocumentAuthor($v)
	{
		...
		if ($this->document_author !== $v) {
			$this->document_author = $v;
			$this->modifiedColumns[] = DocumentPeer::DOCUMENT_AUTHOR;
		}
	...
	public function hydrate(ResultSet $rs, $startcol = 1)
	{
		try {
			...
			$this->document_model = $rs->getString($startcol + 1);

			$this->document_author = $rs->getInt($startcol + 2);
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		$result = array(
			$keys[0] => $this->getId(),
			$keys[1] => $this->getDocumentModel(),
			$keys[2] => $this->getDocumentAuthor(),
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[1], $arr)) $this->setDocumentModel($arr[$keys[1]]);
		if (array_key_exists($keys[2], $arr)) $this->setDocumentAuthor($arr[$keys[2]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(DocumentPeer::DOCUMENT_MODEL)) $criteria->add(DocumentPeer::DOCUMENT_MODEL, $this->document_model);
		if ($this->isColumnModified(DocumentPeer::DOCUMENT_AUTHOR)) $criteria->add(DocumentPeer::DOCUMENT_AUTHOR, $this->document_author);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setDocumentAuthor($this->document_author);
