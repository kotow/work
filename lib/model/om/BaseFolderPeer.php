...
abstract class BaseFolderPeer {
	...
	const ID = 'm_folder.ID';

	
	const LABEL = 'm_folder.LABEL';

	
	const CREATED_AT = 'm_folder.CREATED_AT';

	
	const UPDATED_AT = 'm_folder.UPDATED_AT';

	
	const PUBLICATION_STATUS = 'm_folder.PUBLICATION_STATUS';
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_COLNAME => array (FolderPeer::ID, FolderPeer::LABEL, FolderPeer::CREATED_AT, FolderPeer::UPDATED_AT, FolderPeer::PUBLICATION_STATUS, ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_COLNAME => array (FolderPeer::ID => 0, FolderPeer::LABEL => 1, FolderPeer::CREATED_AT => 2, FolderPeer::UPDATED_AT => 3, FolderPeer::PUBLICATION_STATUS => 4, ),
	...
	{
		include_once 'lib/model/map/FolderMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.map.FolderMapBuilder');
	}
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(FolderPeer::LABEL);

		$criteria->addSelectColumn(FolderPeer::CREATED_AT);

		$criteria->addSelectColumn(FolderPeer::UPDATED_AT);

		$criteria->addSelectColumn(FolderPeer::PUBLICATION_STATUS);

	}

	const COUNT = 'COUNT(m_folder.ID)';
	const COUNT_DISTINCT = 'COUNT(DISTINCT m_folder.ID)';
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/map/FolderMapBuilder.php';
	Propel::registerMapBuilder('lib.model.map.FolderMapBuilder');
}
