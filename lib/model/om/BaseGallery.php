...
abstract class BaseGallery extends BaseObject  implements Persistent {
	...
	public function setLabel($v)
	{
		...
		if ($this->label !== $v) {
			$this->label = $v;
			$this->modifiedColumns[] = GalleryPeer::LABEL;
		}
	...
	public function setImage($v)
	{
		...
		if ($this->image !== $v) {
			$this->image = $v;
			$this->modifiedColumns[] = GalleryPeer::IMAGE;
		}
	...
	public function setRds($v)
	{
		...
		if ($this->rds !== $v) {
			$this->rds = $v;
			$this->modifiedColumns[] = GalleryPeer::RDS;
		}
	...
	public function setPublicationStatus($v)
	{
		...
		if ($this->publication_status !== $v) {
			...
			$this->modifiedColumns[] = GalleryPeer::PUBLICATION_STATUS;
		}
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[4], $arr)) $this->setRds($arr[$keys[4]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(GalleryPeer::LABEL)) $criteria->add(GalleryPeer::LABEL, $this->label);
		if ($this->isColumnModified(GalleryPeer::IMAGE)) $criteria->add(GalleryPeer::IMAGE, $this->image);
		if ($this->isColumnModified(GalleryPeer::DESCRIPTION)) $criteria->add(GalleryPeer::DESCRIPTION, $this->description);
		if ($this->isColumnModified(GalleryPeer::RDS)) $criteria->add(GalleryPeer::RDS, $this->rds);
		...
		if ($this->isColumnModified(GalleryPeer::PUBLICATION_STATUS)) $criteria->add(GalleryPeer::PUBLICATION_STATUS, $this->publication_status);
