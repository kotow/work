...
class MediaMapBuilder {
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('m_media');
		...
		$tMap->addColumn('FILEDIRPATH', 'Filedirpath', 'string', CreoleTypes::VARCHAR, false, 255);

		$tMap->addColumn('FILETYPE', 'Filetype', 'string', CreoleTypes::VARCHAR, false, 255);
