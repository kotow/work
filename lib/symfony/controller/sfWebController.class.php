...
abstract class sfWebController extends sfController
{
   ...
   */
	public function redirect($url, $delay = 0, $statusCode = 302, $secure = false)
	{
		if(($secure || is_numeric(sfContext::getInstance()->getUser()->getSubscriberId())) && sfConfig::get("sf_app") != "backend")
		{
