...
require_once sfConfig::get('sf_lib_dir').'/modules/search/lib/Lucene/Document/Html.php';

/** Zend_Search_Lucene_Document_Docx */
require_once sfConfig::get('sf_lib_dir').'/modules/search/lib/Lucene/Document/Docx.php';

/** Zend_Search_Lucene_Document_Pptx */
require_once sfConfig::get('sf_lib_dir').'/modules/search/lib/Lucene/Document/Pptx.php';

/** Zend_Search_Lucene_Document_Xlsx */
require_once sfConfig::get('sf_lib_dir').'/modules/search/lib/Lucene/Document/Xlsx.php';

/** Zend_Search_Lucene_Search_QueryParser */
require_once sfConfig::get('sf_lib_dir').'/modules/search/lib/Lucene/Search/QueryParser.php';

/** Zend_Search_Lucene_Search_QueryHit */
require_once sfConfig::get('sf_lib_dir').'/modules/search/lib/Lucene/Search/QueryHit.php';

/** Zend_Search_Lucene_Analysis_Analyzer */
require_once sfConfig::get('sf_lib_dir').'/modules/search/lib/Lucene/Analysis/Analyzer.php';

/** Zend_Search_Lucene_Search_Query_Term */
require_once sfConfig::get('sf_lib_dir').'/modules/search/lib/Lucene/Search/Query/Term.php';

/** Zend_Search_Lucene_Search_Query_Phrase */
require_once sfConfig::get('sf_lib_dir').'/modules/search/lib/Lucene/Search/Query/Phrase.php';
...
require_once sfConfig::get('sf_lib_dir').'/modules/search/lib/Lucene/Search/Query/Wildcard.php';

/** Zend_Search_Lucene_Search_Query_Range */
require_once sfConfig::get('sf_lib_dir').'/modules/search/lib/Lucene/Search/Query/Range.php';

/** Zend_Search_Lucene_Search_Query_Fuzzy */
require_once sfConfig::get('sf_lib_dir').'/modules/search/lib/Lucene/Search/Query/Fuzzy.php';
...
require_once sfConfig::get('sf_lib_dir').'/modules/search/lib/Lucene/Search/Query/Insignificant.php';
...
require_once sfConfig::get('sf_lib_dir').'/modules/search/lib/Lucene/Interface.php';

/** Zend_Search_Lucene_Index_SegmentInfo */
require_once sfConfig::get('sf_lib_dir').'/modules/search/lib/Lucene/Index/SegmentInfo.php';

/** Zend_Search_Lucene_LockManager */
require_once sfConfig::get('sf_lib_dir').'/modules/search/lib/Lucene/LockManager.php';
...
class Zend_Search_Lucene implements Zend_Search_Lucene_Interface
{
     ...
     * @var integer
     */
    private static $_termsPerQueryLimit = 999;
    ...
    public static function create($directory)
    {
        ...
        require_once sfConfig::get('sf_lib_dir').'/modules/search/lib/Lucene/Proxy.php';
    ...
    public function __construct($directory = null, $create = false)
    {
        ...
        if (is_string($directory)) {
            require_once sfConfig::get('sf_lib_dir').'/modules/search/lib/Lucene/Storage/Directory/Filesystem.php';
        ...
        if ($create) {
            ...
            require_once sfConfig::get('sf_lib_dir').'/modules/search/lib/Lucene/Index/Writer.php';
    ...
    public function resetTermsStream()
    {
        if ($this->_termsStream === null) {
            ...
            require_once sfConfig::get('sf_lib_dir').'/modules/search/lib/Lucene/TermStreamsPriorityQueue.php';
