...
require_once sfConfig::get('sf_lib_dir').'/modules/search/lib/Lucene/Search/QueryToken.php';



/** Zend_Search_Lucene_FSM */
require_once sfConfig::get('sf_lib_dir').'/modules/search/lib/Lucene/FSM.php';
...
class Zend_Search_Lucene_Search_QueryParser extends Zend_Search_Lucene_FSM
{
    ...
    public function __construct()
    {
        ...
        require_once sfConfig::get('sf_lib_dir').'/modules/search/lib/Lucene/Search/QueryLexer.php';
    ...
    public static function parse($strQuery, $encoding = null)
    {
        ...
        try {
            require_once sfConfig::get('sf_lib_dir').'/modules/search/lib/Lucene/Search/QueryParserContext.php';
    ...
    {
        require_once sfConfig::get('sf_lib_dir').'/modules/search/lib/Lucene/Search/QueryEntry/Term.php';
    ...
    {
        require_once sfConfig::get('sf_lib_dir').'/modules/search/lib/Lucene/Search/QueryEntry/Phrase.php';
