...
<form id='form' name='form' action='<?php echo $formAction; ?>' onsubmit='return validateEditForm()' method='POST'>
	...
	<?php echo backend_input('attrLabel', $obj, array('labelname' => 'Label' , 'model' => 'Product', 'maxlength' => '255', 'required' => 'true', 'onfocus' => ' validateEditForm();'), 'getLabel'); ?>
	<?php echo backend_keywords('attrKeywords', $obj, array('labelname' => 'Keywords' , 'model' => 'Product', 'maxlength' => '255'), 'getKeywords'); ?>
