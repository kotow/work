...
<form id='form' name='form' action='<?php echo $formAction; ?>' onsubmit='return validateEditForm()' method='POST'>
	...
	<?php echo backend_input('attrLabel', $obj, array('labelname' => 'Label' , 'model' => 'Newsletter', 'maxlength' => '255', 'required' => 'true', 'onfocus' => ' validateEditForm();'), 'getLabel'); ?>
	<?php echo backend_textarea('attrContent', $obj, array('labelname' => 'Content' , 'model' => 'Newsletter', 'size' => '50', 'richtext' => 'true', 'rows' => '20'), 'getContent'); ?>
