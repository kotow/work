...
class newsletterActions extends sfActions
{
	...
	public function executeSendNewsletter()
	{
		...
		if($mailinglistsFolder) $this->mailinglists = Document::getChildrenOf($mailinglistsFolder->getId(), "Mailinglist");
	...
	public function executeNewsletter()
	{
		...
		if($newsletter) $this->content = $newsletter->getContent();
		$this->setLayout(false);
	}

	public function executeEditNewsletter()
	{
		BackendService::objectEdit('newsletter', 'Newsletter', $this);
	}

	public function executeEditSubscriber()
	{
		BackendService::objectEdit('newsletter', 'Subscriber', $this);
	}
