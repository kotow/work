...
<form id='form' name='form' action='<?php echo $formAction; ?>' onsubmit='return validateEditForm()' method='POST'>
	...
	<?php echo backend_input('attrLabel', $obj, array('labelname' => 'Label' , 'model' => 'Page', 'maxlength' => 255, 'required' => 'true', 'onfocus' => ' validateEditForm();'), 'getLabel'); ?>
	<?php //echo backend_input('attrRewriteUrl', $obj, array('labelname' => 'Url Rewrite' , 'model' => 'Page', 'maxlength' => 255), 'getRewriteUrl'); ?>
