...
<form id='form' name='form' action='<?php echo $formAction; ?>' onsubmit='return validateEditForm()' method='POST'>
	...
	<?php echo backend_input('attrLabel', $obj, array('labelname' => 'Label' , 'model' => 'TopicI18n', 'maxlength' => 255, 'required' => 'true', 'onfocus' => ' validateEditForm();'), 'getLabel'); ?>
	<?php echo backend_input('attrNavigationTitle', $obj, array('labelname' => 'Navigation title' , 'model' => 'TopicI18n', 'maxlength' => 255), 'getNavigationTitle'); ?>
	<?php echo backend_select('attrCulture', $obj, Lists::getListitemsForSelect('culture'), array('labelname' => 'Culture' , 'model' => 'TopicI18n', 'unique' => 'true', 'required' => 'true', 'onchange' => ' validateEditForm();'), 'getCulture'); ?>
