...
<form id='form' name='form' action='<?php echo $formAction; ?>' onsubmit='return validateEditForm()' method='POST'>
	...
	<?php echo backend_input('attrLabel', $obj, array('labelname' => 'Label' , 'model' => 'Favorite', 'maxlength' => '255', 'required' => 'true', 'onfocus' => ' validateEditForm();'), 'getLabel'); ?>
	<?php echo backend_input('attrDocument', $obj, array('labelname' => 'Document' , 'model' => 'Favorite', 'required' => 'true', 'onfocus' => ' validateEditForm();'), 'getDocument'); ?>
