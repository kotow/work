<div class="qfEntryHeader">
	<span>Upload New Trademarks / Add New Trademark</span>
</div>
...
*/ ?>
<?php $kindVal =  $sf_params->get('kind') ? $sf_params->get('kind') : $trademark->getKind(); ?>
...
<?php endforeach; ?>
		...
		<div class="qfTwoColsBox">
			<div class="qfTwoCol qfTwoCol01">
				...
				<?php echo frontend_input('label', $trademark, array(), 'getLabel'); ?>
...
*/ ?>
<?php $owId = $sf_params->get('owner') ? $sf_params->get('owner') : 0; ?>
...
<?php endforeach; ?>
				...
				<?php echo frontend_input('rights_owner', $trademark, array(), 'getRightsOwner'); ?>
				<label for="rights_owner_address">Адрес на притежателя (нов): </label>
				<?php echo frontend_textarea('rights_owner_address', $trademark, array('size'=>'50x1'), 'getRightsOwnerAddress'); ?>
				<label for="rights_representative">Представител: </label>
				<?php echo frontend_input('rights_representative', $trademark, array(), 'getRightsRepresentative'); ?>
				<label for="rights_representative_address">Адрес на представителя: </label>
				<?php echo frontend_textarea('rights_representative_address', $trademark, array('size'=>'50x1'), 'getRightsRepresentativeAddress'); ?>
			</div>
<?php 
...
?>
			<div class="qfTwoCol qfTwoCol02">
				...
				<?php echo frontend_input('vienna_classes', $trademark, array(), 'getViennaClasses'); ?>
				<label for="colors">Цветове: </label>
				<?php echo frontend_input('colors', $trademark, array(), 'getColors'); ?>
				<label for="publications">Публикации (Формат: "Дата | Текст"): </label>
				<?php echo frontend_textarea('publications', $trademark, array('size'=>'50x3'), 'getPublications'); ?>
			</div>
		</div>
		<div class="qfTogFmPiece">
			...
			<div class="qfTwoColsBox">
				<div class="qfTwoCol qfTwoCol01">
					...
					<?php echo frontend_input('application_number', $trademark, array(), 'getApplicationNumber'); ?>
					<label for="register_number">Регистров номер: </label>
					<?php echo frontend_input('register_number', $trademark, array(), 'getRegisterNumber'); ?>
					<label for="application_date">Дата на заявяване:* </label>
					<?php echo frontend_input('application_date', $trademark, array('class'=>'qfDatePick', 'id'=>'datepicker'), 'getApplicationDate'); ?>
					<label for="registration_date">Дата на регистриране: </label>
					<?php echo frontend_input('registration_date', $trademark, array('class'=>'qfDatePick', 'id'=>'datepicker2'), 'getRegistrationDate'); ?>
					<h3 class="qfFmPieceHeading">Класове</h3>
					<label for="nice_classes">Класове по Ницска класификация:* </label>
					<?php echo frontend_input('nice_classes', $trademark, array(), 'getNiceClasses'); ?>
				</div>
				<div class="qfTwoCol qfTwoCol02">
					<label for="expires_on">Срок:* </label>
					<?php echo frontend_input('expires_on', $trademark, array('class'=>'qfDatePick', 'id'=>'datepicker3'), 'getExpiresOn'); ?>
					
					<label for="expires_on">Краен срок за опозиция:* </label>
					<?php echo frontend_input('contestation', $trademark, array('class'=>'qfDatePick', 'id'=>'datepicker4'), 'getContestation'); ?>
					
					<label for="office_of_origin">Държава на регистрация:* </label>
					<?php echo frontend_input('office_of_origin', $trademark, array(), 'getOfficeOfOrigin'); ?>
					...
					<?php echo frontend_input('designated_contracting_party', $trademark, array(), 'getDesignatedContractingParty'); ?>
					<label for="status">Статус: </label>
					<?php //<input type="text" id="status" name="status" readonly value="Registered"> ?>
                    <?php echo frontend_input('status', $trademark, array(), 'getStatus'); ?>  
				</div>
			</div>
		</div>
