...
<form method='POST' action='<?php echo $formAction; ?>' name='editForm' id='editForm'>
	...
	<?php //$userTypes = array('admin' => 'admin', 'editor' => 'editor'); ?>
	<?php //echo panel_select('attrUserType', $obj, /*Lists::getListitemsForSelect('user_types')*/ $userTypes, array(/*'onchange' => 'show_hide_admin_options(this)',*/ 'labelname' => 'Account type' , 'model' => 'User', 'class'=>'medium'), 'getUserType'); ?>
...
<?php if (strstr($user->getType(), 'admin')): ?>
	<?php echo panel_input('attrLogin', $obj, array('labelname' => 'Login' , 'model' => 'User', 'maxlength' => '100', 'class' => 'large'), 'getLogin'); ?>
<?php endif; ?>
...
<?php if (strstr($user->getType(), 'admin')): ?>
	<?php echo panel_checkbox('attrBackend', $obj, array('labelname' => 'Backend' , 'model' => 'User'), 'getBackend'); ?>
<?php else: ?>
	<?php echo panel_hidden('attrBackend', $obj, array('labelname' => 'Backend' , 'model' => 'User'), 'getBackend'); ?>
<?php endif; ?>
	<?php echo panel_select('attrType', $obj, Lists::getListitemsForSelect('usertype'), array('labelname' => 'Type' , 'model' => 'User', 'class'=>'medium'), 'getType'); ?>
