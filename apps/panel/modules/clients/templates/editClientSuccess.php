...
<form method='POST' action='<?php echo $formAction; ?>' name='editForm' id='editForm'>
	...
	<?php echo panel_input('attrLabel', $obj, array('labelname' => 'Title', 'maxlength' => 255, 'required' => 'true', 'class' => 'large'), 'getLabel'); ?>
	<?php echo panel_textarea('attrAddress', $obj, array('labelname' => 'Address', 'size'=> '70x5'), 'getAddress'); ?>
