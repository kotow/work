...
<form method='POST' action='<?php echo $formAction; ?>' name='editForm' id='editForm'>
	...
	<?php echo panel_input('attrLabel', $obj, array('labelname' => 'Label' , 'model' => 'Subscriber', 'maxlength' => 255, 'required' => 'true', 'class' => 'large'), 'getLabel'); ?>
	<?php echo panel_input('attrEmail', $obj, array('labelname' => 'Label' , 'model' => 'Subscriber', 'maxlength' => 255, 'required' => 'true', 'class' => 'large'), 'getEmail'); ?>
