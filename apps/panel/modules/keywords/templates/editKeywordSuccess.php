...
<form method='POST' action='<?php echo $formAction; ?>' name='editForm' id='editForm'>
	...
	<?php echo panel_input('attrLabel', $obj, array('labelname' => 'Label' , 'model' => 'Keyword', 'maxlength' => '255', 'required' => 'true', 'class' => 'medium'), 'getLabel'); ?>
	<?php //echo panel_input('attrShort', $obj, array('labelname' => 'Short' , 'model' => 'Keyword', 'maxlength' => '63', 'required' => 'true', 'class' => 'medium'), 'getShort'); ?>
