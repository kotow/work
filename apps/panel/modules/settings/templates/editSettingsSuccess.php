...
<form method='POST' action='' name='editForm' id='editForm'>
	<?php echo panel_hidden('moduleName', 'settings'); ?>
	...
	<?php echo panel_input('attrValue', $val, array('labelname' => 'Value' , 'model' => 'Settings', 'maxlength' => '255', 'required' => true, 'class' => 'large'), 'getValue'); ?>
