...
<form method='POST' action='<?php echo $formAction; ?>' name='editForm' id='editForm'>
	...
	<?php echo panel_select('attrClientId', $obj, $ownersArr, array('labelname' => 'Client', 'class' => 'medium'), 'getClientId'); ?>
	...
	<?php echo panel_image('attrImage', $obj, array('labelname' => 'Image', 'allowed' => 'images', 'thumb_width' => 105), 'getImage'); ?>
