...
//var_dump($user_rights[$module][$class]);
		...
		if ( isset($module_rights[$class]) && ($module_rights[$class] > '') )
			$href = 'href="?m='.$sf_params->get('m').'&p='.$id.'"';
		else if ($user_rights[$module][$class]['edit'])
			$href = 'href="?m='.$sf_params->get('m').'&id='.$item->getId().'"';
		else
	...
	?>
				<li class="ui-state-default" id="<?php echo $class.'_'.$id; ?>">
					<div class="row">
						...
						<div class="col-f">
<?php if ( isset($user_rights[$module][$class]) && isset($user_rights[$module][$class]['delete']) ): ?>
...
<?php endif; ?>
						...
						<div class="col-f">
<?php if ( isset($user_rights[$module][$class]) && isset($user_rights[$module][$class]['order']) ): ?>
...
<?php endif; ?>
						...
						<div class="col-f">
<?php if ( isset($user_rights[$module][$class]) && isset($user_rights[$module][$class]['edit']) ): ?>
...
<?php endif; ?>
						...
						<div class="col-f"><a href="javascript:void(0);" title="Status" class="status <?php if (Document::getStatus($item) != UtilsHelper::STATUS_ACTIVE) echo 'offline'; ?>"></a></div>
						<div class="clear"></div>
					</div>
				</li>
	<?php endforeach; ?>
