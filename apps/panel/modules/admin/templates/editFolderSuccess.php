...
<form method='POST' action='<?php echo $formAction; ?>' name='editForm' id='editForm'>
	<?php if ($moduleName && $documentName): ?>
		<?php echo panel_hidden('parentModule', $sf_request->getParameter('parentModule')); ?>
	...
	<?php echo panel_input('attrLabel', $obj, array('labelname' => 'Label' , 'model' => 'Folder', 'maxlength' => 255, 'required' => 'true', 'class' => 'large'), 'getLabel'); ?>
