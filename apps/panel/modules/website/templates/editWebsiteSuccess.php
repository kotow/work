...
<form method="POST" action="<?php echo $formAction; ?>" name="editForm" id="editForm">
	...
	<?php echo panel_input('attrLabel', $obj, array('labelname' => 'Label' , 'model' => 'Website', 'maxlength' => 255, 'required' => 'true', 'class' => 'large'), 'getLabel'); ?>
	<?php echo panel_input('attrUrl', $obj, array('labelname' => 'Url' , 'model' => 'Website', 'maxlength' => 255, 'validate' => 'Url', 'class' => 'large'), 'getUrl'); ?>
