...
<form method="POST" action="<?php echo $formAction; ?>" name="editForm" id="editForm">
	...
	<?php echo panel_input('attrLabel', $obj, array('labelname' => 'Label' , 'model' => 'TopicI18n', 'maxlength' => 255, 'required' => 'true', 'class' => 'large'), 'getLabel'); ?>
	<?php echo panel_input('attrNavigationTitle', $obj, array('labelname' => 'Navigation title' , 'model' => 'TopicI18n', 'maxlength' => 255, 'class' => 'large'), 'getNavigationTitle'); ?>
