...
<?php if($obj && $userType != "admin" && $obj->getListType() == "system"): ?>
	<p class="error">Only ADMIN can edit "system" lists!</p>
<?php else: ?>
...
<form method='POST' action='<?php echo $formAction; ?>' name='editForm' id='editForm'>
	...
	<?php echo panel_input('attrLabel', $obj, array('labelname' => 'Label' , 'model' => 'Lists', 'maxlength' => '255', 'required' => 'true', 'class' => 'medium'), 'getLabel'); ?>
	<?php echo panel_input('attrListId', $obj, array('labelname' => 'List ID' , 'model' => 'Lists', 'maxlength' => '255', 'required' => 'true', 'class' => 'medium'), 'getListId'); ?>
	<?php echo panel_select('attrListType', $obj, Lists::getListitemsForSelect('list_types'), array('labelname' => 'List type', 'model' => 'Lists', 'required' => 'true', 'class' => 'medium'), 'getListType'); ?>
