...
<form method='POST' action='<?php echo $formAction; ?>' name='editForm' id='editForm'>
	...
	<?php echo panel_input('attrLabel', $obj, array('labelname' => 'Label' , 'model' => 'Listitem', 'maxlength' => '255', 'required' => 'true', 'class' => 'medium'), 'getLabel'); ?>
	<?php echo panel_input('attrValue', $obj, array('labelname' => 'Value' , 'model' => 'Listitem', 'maxlength' => '255', 'class' => 'medium'), 'getValue'); ?>
