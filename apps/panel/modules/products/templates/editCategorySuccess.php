...
<form method="POST" action="<?php echo $formAction; ?>" name="editForm" id="editForm">
	...
	<?php echo panel_input('attrLabel', $obj, array('labelname' => 'Label' , 'model' => 'Category', 'maxlength' => '255', 'required' => 'true', 'class' => 'large'), 'getLabel'); ?>
	<?php echo panel_image('attrImage', $obj, array('labelname' => 'Image' , 'model' => 'Category', 'allowed' => 'images'), 'getImage'); ?>
