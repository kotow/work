...
jQuery.fn.rte = function(css_url) {
    ...
    function toolbar(iframe) {
        var tb = $("<div class='rte-toolbar'><div>\
            ...
            <p>\
                <a href='#' class='bold'><img src='../media/icons/bold.gif' alt='bold' /></a>\
                <a href='#' class='italic'><img src='../media/icons/italic.gif' alt='italic' /></a>\
            </p>\
            <p>\
                <a href='#' class='unorderedlist'><img src='../media/icons/unordered.gif' alt='unordered list' /></a>\
                <a href='#' class='link'><img src='../media/icons/link.png' alt='link' /></a>\
                <a href='#' class='image'><img src='../media/icons/image.png' alt='image' /></a>\
                <a href='#' class='disable'><img src='../media/icons/close.gif' alt='close rte' /></a>\
            </p></div></div>");
